...
class tf47_ccl_base_rsctext : tf47_ccl_base
{
	idc = -1;
	fixedWidth = 0;
	h = 0.036;
...
class tf47_ccl_base_rscbutton : tf47_ccl_base
{
	type = 1;
...
class tf47_ccl_base_rscbutton_main : tf47_ccl_base_rscbutton
{
...
class tf47_ccl_base_rscedit : tf47_ccl_base
{
	type = 2;
	h = 0.04;
	w = 0.2;
...
class tf47_ccl_base_textbutton 
{
	type = 11;
	style = 0;
	font = "PuristaLight";
...
class tf47_ccl_base_frame : tf47_ccl_base
{
	idc = -1;
	style = 64;
	shadow = 2;
...
class tf47_ccl_base_combo : tf47_ccl_base
{
	type = 4;
	colorSelect[] = {0,0,0,1};
	colorText[] = {0.95,0.95,0.95,1};
	...
	maxHistoryDelay = 1;
	class ComboScrollBar : tf47_ccl_scrollbar
	{
	};
	style = 16;
	w = 0.12;
...
class tf47_ccl_base_listbox : tf47_ccl_base
{
	type = 5;
	w = 0.4;
	h = 0.4;
	...
	class ListScrollBar : tf47_ccl_scrollbar
	{
	};
	style = 16;
	shadow = 0;
...
class tf47_ccl_base_progressbar
{
	type = 8;
	style = 0;
	colorFrame[] = {0,0,0,1};
